...
parser.add_argument('--ckpt', type=str, default='./pretrained/ckpt_0.026496_300000.pt')
parser.add_argument('--categories', type=str_list, default=['lamp'])
parser.add_argument('--save_dir', type=str, default='./results')
parser.add_argument('--device', type=str, default='cuda')
# Datasets and loaders
parser.add_argument('--dataset_path', type=str, default='./data/lamp_last.hdf5')
...
#     recons=all_recons[i][:][:]
#     np.savetxt('./gen_cls/19/%d.txt' % i, recons)
...
np.save(os.path.join(save_dir, 'ref_lamp.npy'), all_ref.numpy())
np.save(os.path.join(save_dir, 'out_lamp.npy'), all_recons.numpy())
np.save(os.path.join(save_dir, 'com_lamp.npy'), all_com.numpy())
